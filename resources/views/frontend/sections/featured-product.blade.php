<div class="bg-white p-3 shadow-xl rounded-md my-5">
    ...
    <h1 class="text-2xl p-2">Featured</h1>
    <ul class="grid  grid-cols-6 py-5 gap-3 cursor-pointer ">
        @foreach ($featuredProducts as $f)
            <li
                ...
                <img class="min-h-[180px] w-full" src="{{ asset($f->thumb_image) }}" />
                ...
                <div class=" p-2">
                    ...
                    <p class="flex justify-between items-center">
                        <span class="text-orange-500 font-bold">${{ $f->price }}</span>
