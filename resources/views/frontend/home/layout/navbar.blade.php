<div class="bg-black p-5">
    <nav class=" flex  md:gap-5 lg:gap-0 lg:justify-between text-white w-[1400px] mx-auto items-center">
        <h1 class="text-2xl"> 
                ...
                <div class="hidden text-black sidebar  md:hidden p-5 fixed left-[0px]  top-[0px] z-10 bg-white h-[100vh] w-[300px]"> 
                    ...
                    @if (Auth::check())
                        ...
                        <div class="mt-5 flex gap-x-3">
                            @if ($user->image)
                            <img  class="cursor-pointer" alt="avatar" width="70" src="{{asset($user->image)}}"/>  
                            @else 
                                <img class="cursor-pointer"  alt="avatar" width="70" src="{{asset("uploads/user-avatar.png")}}"/>  
                            @endif
                      
                        <h1 class="cursor-pointer text-xl p-2">{{$user->name}}  {{$user->email}}</h1>
                        </div>
        ...
        <div class="md:w-[20%] lg:w-[40%] w-[20%] ml-8 flex items-center">
        ...
        <div class="border-2 border-white py-2 px-2 md:px-6 ">
